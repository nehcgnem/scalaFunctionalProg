...
class NonEmpty(elem: Tweet, left: TweetSet, right: TweetSet) extends TweetSet {
  ...
  def mostRetweeted: Tweet = {
    def mostHelper(x: Tweet, y:Tweet): Tweet =
      if(x.retweets > y.retweets) x else y

    if (left.isEmpty && right.isEmpty) elem
    else if(left.isEmpty) mostHelper(right.mostRetweeted, elem)
    else if(right.isEmpty) mostHelper(left.mostRetweeted, elem)
    else mostHelper(mostHelper(left.mostRetweeted, right.mostRetweeted), elem)
